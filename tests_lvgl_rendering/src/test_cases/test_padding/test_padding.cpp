...
TEST("test_pad_all") {
    ...
    lv_obj_set_size(obj, 200, 200);
    lv_obj_center(obj);
    SET_PADDING_STYLE(obj, ENUM_PADDING_STYLE_TEST_PAD_ALL);
...
TEST("test_pad_gap") {
    ...
    SET_PADDING_STYLE(obj, ENUM_PADDING_STYLE_TEST_PAD_GAP);

    lv_obj_add_state(obj, LV_STATE_DEFAULT);
    TEST_REQUIRE(lv_obj_get_style_pad_row(obj, LV_PART_MAIN)    == 10);
    TEST_REQUIRE(lv_obj_get_style_pad_column(obj, LV_PART_MAIN) == 10);

    lv_obj_add_state(obj, LV_STATE_USER_1);
    TEST_REQUIRE(lv_obj_get_style_pad_row(obj, LV_PART_MAIN)    == 30);
    TEST_REQUIRE(lv_obj_get_style_pad_column(obj, LV_PART_MAIN) == 30);

    lv_obj_add_state(obj, LV_STATE_USER_2);
    TEST_REQUIRE(lv_obj_get_style_pad_row(obj, LV_PART_MAIN)    == 0);
    TEST_REQUIRE(lv_obj_get_style_pad_column(obj, LV_PART_MAIN) == 0);
}
...
TEST("test_pad_hor") {
    ...
    lv_obj_set_size(obj, 200, 200);
    lv_obj_center(obj);
    SET_PADDING_STYLE(obj, ENUM_PADDING_STYLE_TEST_PAD_HOR);
...
TEST("test_pad_ver") {
    ...
    lv_obj_set_size(obj, 200, 200);
    lv_obj_center(obj);
    SET_PADDING_STYLE(obj, ENUM_PADDING_STYLE_TEST_PAD_VER);
